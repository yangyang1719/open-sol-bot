...
async def test_main_function():
    ...
    mock_loop.add_signal_handler.assert_any_call(signal.SIGTERM, mock_loop.add_signal_handler.call_args_list[0][0][1])
    mock_loop.add_signal_handler.assert_any_call(signal.SIGINT, mock_loop.add_signal_handler.call_args_list[1][0][1])
