...
async def service_with_mocks(mock_redis_client, mock_caches):
    ...
    with patch("cache_preloader.services.auto_update_service.RedisClient") as mock_redis:
        ...
        with patch("cache_preloader.services.auto_update_service.BlockhashCache", return_value=mock_caches[0]):
            with patch("cache_preloader.services.auto_update_service.MinBalanceRentCache", return_value=mock_caches[1]):
